...
namespace RoleManagement.Infrastructure.Migrations
{
    ...
    [Migration("20231111172103_cityTables")]
    partial class cityTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoleManagement.Domain.Models.City", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RoleManagement.Domain.Models.District", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RoleManagement.Domain.Models.Region", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RoleManagement.Domain.Models.District", b =>
                {
                    b.HasOne("RoleManagement.Domain.Models.Region", "Region")
                        .WithMany()
            ...
            modelBuilder.Entity("RoleManagement.Domain.Models.Region", b =>
                {
                    b.HasOne("RoleManagement.Domain.Models.City", "City")
                        .WithMany()
